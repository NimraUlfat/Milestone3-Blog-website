    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <div>
        ...
        <p className="text-gray-400 text-sm">
          Glow & Glam is your ultimate beauty destination. We provide expert tips, tutorials, product reviews, and the latest beauty trends to help you look and feel your best. From skincare secrets to makeup magic, we have got everything you need to glow with confidence.
        </p>
      </div>
